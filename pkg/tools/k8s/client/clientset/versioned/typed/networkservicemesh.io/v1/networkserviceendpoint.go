...
type NetworkServiceEndpointInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*v1.NetworkServiceEndpointList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.NetworkServiceEndpoint, err error)
...
func newNetworkServiceEndpoints(c *NetworkservicemeshV1Client, namespace string) *networkServiceEndpoints {
...
func (c *networkServiceEndpoints) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.NetworkServiceEndpoint, err error) {
...
func (c *networkServiceEndpoints) List(ctx context.Context, opts metav1.ListOptions) (result *v1.NetworkServiceEndpointList, err error) {
...
func (c *networkServiceEndpoints) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkServiceEndpoints) Create(ctx context.Context, networkServiceEndpoint *v1.NetworkServiceEndpoint, opts metav1.CreateOptions) (result *v1.NetworkServiceEndpoint, err error) {
	result = &v1.NetworkServiceEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkserviceendpoints").
...
func (c *networkServiceEndpoints) Update(ctx context.Context, networkServiceEndpoint *v1.NetworkServiceEndpoint, opts metav1.UpdateOptions) (result *v1.NetworkServiceEndpoint, err error) {
	result = &v1.NetworkServiceEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkserviceendpoints").
...
func (c *networkServiceEndpoints) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *networkServiceEndpoints) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkServiceEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.NetworkServiceEndpoint, err error) {
	result = &v1.NetworkServiceEndpoint{}
